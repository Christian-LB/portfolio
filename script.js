...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if ((window.matchMedia("(min-width: 401px)").matches && window.matchMedia("(max-height: 751px)").matches) && (window.location.pathname === '/aboutme.html' || window.location.href.includes('aboutme.html'))) {
    document.body.classList.add('no-fixed');
  }

  if ((window.matchMedia("(min-width: 401px)").matches && window.matchMedia("(max-height: 751px)").matches) && (window.location.pathname === '/tech.html' || window.location.href.includes('tech.html'))) {
    document.body.classList.add('no-fixed');
  }