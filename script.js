...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (((window.matchMedia("(max-width: 600px)").matches || window.matchMedia("(max-height: 700px)").matches)) && (window.location.pathname === '/aboutme.html' || window.location.href.includes('aboutme.html'))) {
    document.body.classList.add('no-fixed');
  }

  if (((window.matchMedia("(max-width: 600px)").matches || window.matchMedia("(max-height: 700px)").matches)) && (window.location.pathname === '/tech.html' || window.location.href.includes('tech.html'))) {
    document.body.classList.add('no-fixed');
  }